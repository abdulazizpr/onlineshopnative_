<?php
	...
	if(isset($_POST['daftar'])){
		...
		$query="insert into pembeli (nama,alamat,no_hp,email,username,password) values ('$nama','$alamat','$no_hp','$email','$username','$password')";
        ...
        <div class="row">
            ...
            <div class="col-md-9">
				...
				<div class="alert alert-success" role="alert">
					<strong> Pendaftaran anda berhasil </strong>
